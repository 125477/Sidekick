...
export function SpriteMenuPanel({
  ...
  return (
    <div
      ...
      className={`sk-toast-shell flex w-[172px] flex-col overflow-hidden rounded-2xl border p-0 [-webkit-app-region:no-drag] divide-y divide-[color:var(--sk-divider)] ${className}`}
    >
